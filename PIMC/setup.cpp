    ...
    cmdLineOptions("Combined Command Line Options")
{
    ...
    externalPotentialName.push_back("hex_tube");
...
PotentialBase * Setup::externalPotential(const Container* boxPtr) {
    ...
    else if (constants()->extPotentialType() == "hex_tube")
		externalPotentialPtr = new LJHexPorePotential(params["radius"].as<double>());
