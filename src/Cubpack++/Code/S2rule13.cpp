...
//  std::cout << "Benadering voor cirkel = " <<TheResult*R.Volume()<<endl;
...
//    std::cout<<"Deg5 = "<<Deg5<<" Deg3 = "<<Deg3<<endl;
    if(Deg5 != 0)
      {
      r1=Deg7/Deg5;
      }
