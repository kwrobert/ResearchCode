#####################################################################################################
# Script: cleanupdirs.py 
# Author: Kyle Robertson
# Del Maestro Research Group
# Description: Simple script for cleaning up the mess of directories created when running jobs on 
# the OSG. Takes all directories containing data of identical simulation params but differing
# process numbers and merges them into one unifying directory.
#####################################################################################################
