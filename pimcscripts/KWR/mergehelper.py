#####################################################################################################
# Script: mergehelper.py
# Author: Kyle Robertson
# Del Maestro Research Group
# Description: A bunch of helper classes and methods used by mergeSeeds.py. Most of this has been 
# taken from pimchelp.py, with extensions and modifications. 
#####################################################################################################
...
def getEstimatorType(estimator):
    ...
    if estimator in ['estimator','super']:
        estType = 'Scalar'
