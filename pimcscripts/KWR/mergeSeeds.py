#####################################################################################################
# Script: mergeSeeds.py
# Author: Kyle Robertson
# Del Maestro Research Group
# Description: A script that merges together all data from a run of many random seeds (process
# numbers). It does this by looping through every unique set of parameters, and every seed for each
# unique parameter set, in a job run. It averages the data from each seed file, then appends all 
# averages to a merged file. The end result is a set of merged data files in a MERGED directory,
# where each data entry in the merged files is the average of all seeds for that particular
# parameter set and file type. 
#####################################################################################################
import argparse
import os
import mergehelper
